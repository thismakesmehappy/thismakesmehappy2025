...
import {includeNavMenu, memojiPlacementFlag} from "src/helpers/featureFlags.ts";
        ...
        <Navbar className="navbar custom-navbar" sticky="top">
            <Container fluid={true} className="custom-navbar-container">
                <div
                    ...
                    {memojiPlacementFlag == "top" && <RandomMemoji key={`${location.pathname}-mobile`} id={"memoji-top"}
                                                                   className="mb-1 d-md-none" />}
                    <Navbar.Brand as={Link} to="/" onClick={handleScrollToTop}
                        ...
                        {memojiPlacementFlag == "top" &&
                            <RandomMemoji key={`${location.pathname}-desktop`} id={"memoji-top"}
